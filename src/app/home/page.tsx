...
export default function Home() {
    return (
        <section className="flex flex-col justify-center items-center h-screen w-full gap-8 text-center text-gray-900 relative">
            ...
            <div className='lg:w-2/3 w-full rounded-lg flex flex-col gap-8 items-center bg-zinc-100 bg-opacity-50 px-4 py-4 shadow-md'>
                <h1 className="2xl:text-5xl lg:text-4xl text-3xl font-bold">Experiencie a melhor aventura cinematográfica</h1>
