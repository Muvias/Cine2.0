...
export default function Location() {
    return (
        <section className="h-screen w-full px-12 pt-6 overflow-y-scroll text-gray-800 bg-gray-100">
            ...
            <div className='max-w-sm w-full flex flex-col my-8 text-gray-900'>
                <SimpleCard
                    image={entranceCine}
                    title='Endereço'
